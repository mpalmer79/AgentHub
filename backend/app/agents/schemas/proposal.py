...
def get_proposal_schema() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        create_tool_schema(
            ...
            properties={
                "project_type": string_prop(
                    "Type: consulting, development, design, marketing, implementation, training, support, strategy"
                ),
                ...
                "timeline_preference": string_prop(
                    "Timeline: rushed, accelerated, standard, flexible"
                ),
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "status_filter": string_prop(
                    "Filter by status: draft, sent, negotiating, won, lost"
                ),
