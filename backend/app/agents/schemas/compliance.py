...
def get_compliance_schema() -> List[Dict[str, Any]]:
    ...
    return [
        create_tool_schema(
            ...
            properties={
                "industry": string_prop(
                    "Industry type: general, healthcare, finance, retail, technology"
                ),
                "jurisdiction": string_prop("Jurisdiction: federal, state, local, international"),
                "categories": array_string_prop(
                    "Categories to monitor: privacy, tax, employment, safety, environmental"
                ),
            },
        ),
        create_tool_schema(
        ...
        create_tool_schema(
            ...
            properties={
                "area": string_prop(
                    "Area to audit: all, data_privacy, financial, employment, licensing"
                ),
        ...
        create_tool_schema(
            ...
            properties={
                "policy_type": string_prop(
                    "Policy type: privacy, data_retention, acceptable_use, incident_response"
                ),
                "company_name": string_prop("Company name to use in the policy"),
                "industry": string_prop(
                    "Industry for context: general, healthcare, finance, retail, technology"
                ),
            },
        ...
        create_tool_schema(
            ...
            properties={
                "report_type": string_prop(
                    "Report type: comprehensive, executive_summary, detailed"
                ),
