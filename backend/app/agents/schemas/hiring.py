    ...
    return [
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "interview_type": string_prop(
                    "Type: phone_screen, technical, behavioral, final, panel"
                ),
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "candidate_name": string_prop("Candidate's full name"),
                "status": string_prop(
                    "Status: application_received, interview_scheduled, under_review, moved_forward, rejection"
                ),
