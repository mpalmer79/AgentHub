    ...
    return [
        create_tool_schema(
            ...
            properties={
                ...
                "category": string_prop(
                    "Filter by category: software, services, supplies, logistics"
                ),
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "service_description": string_prop(
                    "Description of the service for better matching"
                ),
            },
        ...
        create_tool_schema(
            ...
            properties={
                "min_savings_threshold": number_prop(
                    "Minimum annual savings to include (default: 100)"
                ),
            },
        ),
        create_tool_schema(
            ...
            properties={
                "vendor_name": string_prop("Name of the vendor"),
                "negotiation_type": string_prop(
                    "Type: renewal, price_reduction, service_upgrade, cancellation_prevention"
                ),
                "current_terms": string_prop("Summary of current contract terms"),
                "desired_outcome": string_prop("What you want to achieve"),
                "tone": string_prop(
                    "Tone: professional, firm, or friendly (default: professional)"
                ),
            },
