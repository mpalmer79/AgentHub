    ...
    return [
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "response_tone": string_prop(
                    "Tone: professional or casual (default: professional)"
                ),
            },
        ...
        create_tool_schema(
            ...
            properties={
                ...
                "customer_names": array_string_prop(
                    "List of customer names (same order as emails)"
                ),
                "platform": string_prop("Platform to request review on (google, yelp, facebook)"),
                "custom_message": string_prop(
                    "Custom message template (use {name} and {platform} placeholders)"
                ),
            },
